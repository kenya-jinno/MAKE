%% main_paper_NN40.tex
%% MDPI MAKE 投稿用日本語草稿
%% 入力データの内在次元に基づく AE/VAE ボトルネック次元の選定（版40）
%% 版40の変更点：Review_codex39.txt（accept with minor corrections）への対応
...
%% コンパイル: platex main_paper_NN40.tex && platex main_paper_NN40.tex && dvipdfmx main_paper_NN40.dvi
...
MNIST・Fashion-MNIST（全結合型 AE/VAE，3シード；
Fashion-MNIST の Step 3 は単一シード），および
