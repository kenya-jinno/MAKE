%% main_paper_NN41.tex
%% MDPI MAKE 投稿用日本語草稿
%% 入力データの内在次元に基づく AE/VAE ボトルネック次元の選定（版41）
%% 版41の変更点：Review_codex40.txt（accept with minor corrections）への対応
...
%% コンパイル: platex main_paper_NN41.tex && platex main_paper_NN41.tex && dvipdfmx main_paper_NN41.dvi
